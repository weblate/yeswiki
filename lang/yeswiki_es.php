...
return [
    ...
    'ONLY_ADMINS_CAN_CHANGE_MEMBERS' => 'Nombre de la página principal',
    ...
    'YOUR_MODIFIED_PAGES_ORDERED_BY_MODIFICATION_DATE' => '¿De verdad quieres eliminar la página {tag} untonbsp permanentemente?',
    ...
    'CLICK_HERE_TO_EDIT' => 'Los nombres de página se añadirán directamente a la URL base de su sitio YesWiki. Eliminar la parte "?" sólo si utiliza la redireccion (ver abajo)',
    ...
    'ADMIN_PASSWORD_ARE_DIFFERENT' => '¿Estás seguro de que quieres eliminar el usuario·ice?',
    ...
    'WRITING_CONFIGURATION_FILE_WIP' => 'Es recomendable eliminar el acceso por escrito al archivo',
    ...
    'REFERRERS_SITES_SINCE' => 'No hay comentario que se haya seleccionado para ser eliminado',
    ...
    'ACLS_AUTHENTIFICATED_USERS' => 'Fin de la ejecución',
    ...
    'NO_SEARCH_RESULT' => 'Esta es una nueva instalación. El programa de instalación tratará de encontrar los valores apropiados. Cámbialos sólo si sabes lo que estás haciendo',
    ...
    'GROUPS' => 'Grupos',
    // handlers/edit
    'EDIT_ALERT_ALREADY_SAVED_BY_ANOTHER_USER' => 'ha sido reconocido como',
    ...
    'DATABASE_YOU_MUST_FIRST_SET_ARGUMENT' => 'La lista de campos a modificar por actualización IntoDB ciertamente es defectuoso',
    ...
    'REACTION_ANGRY' => 'Resultados de la búsqueda',
    ...
    'COMMENT_NEW_COMMENT_TAG' => 'O crear un nuevo grupo',
    ...
    'REACTION_NO_IMAGE' => 'Confirme la actualización de la página:',
...
SuperCat identificado/b impuesto (negación, SuperCat no está permitido)',
    ...
    'USER_YOU_MUST_SPECIFY_YES_OR_NO' => 'Volver a la forma',
    ...
    'REVISION_ON' => 'desde',
    'YW_CHANGE_OWNER' => 'Por favor complete el siguiente formulario',
    ...
    'USER_TRYING_TO_MODIFY_AN_INEXISTANT_USER' => 'Nuevo CL registrado con éxito para el manipulador',
