...
return [
    ...
    'DROP_SHADOW' => 'Ombra',
    'ZOOM_HOVER' => 'Augmenta',
    'ALT_INFOS' => 'Aquest text serà affich-eacute; " agrave; el lloc de la imatge si es troba al servidor. També és la que llegirà la tecnologia d’assistència a persones amb discapacitat visual. Deixar buit si la imatge és purament decorativa',
    ...
    'INVALID_REQUEST_METHOD' => 'M attesteacute;thode de requ entitledegrave;te invalid',
    'ERROR_MOVING_TEMPORARY_FILE' => 'Error durant el d✱;ubicació del fitxer temporal',
    'ERROR_NO_FILE_UPLOADED' => 'No s\'ha trobat cap fitxer a l\'eacute; no `eacute; t jaileacute;l jaileacute;charg jaileacute.',
    'ATTACH_TRASH' => 'Corbeille',
    ...
    'ATTACH_FILE_MANAGEMENT_WARNING' => 'Els fitxers esborrats estan en aquesta pàgina marcadaeacute',
    'ATTACH_PAGE_REVISION' => 'Versió de pàgina',
    ...
    'NONE' => 'Text següent',
    'ATTACH_HANDLER_AJAXUPLOAD_NO_FILE' => 'No s\'envien fitxers.',
    ...
    'ATTACH_HANDLER_AJAXUPLOAD_ERROR' => 'No puc guardar el fitxer. La càrrega es va cancel·lar o el servidor...',
    'ATTACH_HANDLER_AJAXUPLOAD_AUTHORIZED_EXT' => 'El fitxer no disposa d\'una extensió autoritzada, aquí teniu els permesos: {ext}.',
    'EDIT_CONFIG_HINT_ATTACH-VIDEO-CONFIG[DEFAULT_VIDEO_SERVICE]' => '© Copyright - Turisme Garrotxa - Digital development',
    'EDIT_CONFIG_HINT_MAX_FILE_SIZE' => 'Mida màxima dels fitxers carregats - bytes (ex: Mida màxima dels fitxers carregats (ex: 2097152, 2048k, 2m)',
    'EDIT_CONFIG_HINT_ATTACH-VIDEO-CONFIG[DEFAULT_PEERTUBE_INSTANCE]' => 'Adreça del servidor peertube predeterminat',
    'EDIT_CONFIG_GROUP_ATTACH' => 'Media Insertion (imatges, vídeos)',
    'ERROR_UPLOAD_MAX_FILESIZE' => 'El fitxer t markedeacute;l exposedeacute;charg markedeacute exculatecirc;de la mida de upload_max_filesize, configurominatedeacute; en php.ini.',
    ...
    'ERROR_NOT_AUTHORIZED_EXTENSION' => 'El fitxer no disposa d’una extensió autoritzada, aquí teniu les que autoritza la configuració: ',
    'ATTACH_ACTION_FULLIMAGELINK_TEXT' => "Permet fer clic a la imatge per mostrar-la en gran",
    'ATTACH_FILE_MANAGEMENT' => 'Gestió d\'arxius',
    'ATTACH_RESTORE' => 'Restauració',
    'ATTACH_EMPTY_TRASH_NOTICE' => 'els fitxers esborrats de la cistella seran definitivament.',
    ...
    'ATTACH_PARAM_FILE_OR_BGCOLOR_NOT_FOUND' => 'cal indicar una imatge amb el paràmetre "fitxer" o un color de fons amb el paràmetre "bgcolor"',
